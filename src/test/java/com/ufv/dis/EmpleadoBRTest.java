...
class EmpleadoBRTest {
    ...
    void calculaSalarioBruto() throws BRException {
        ...
        assertEquals(1260, empleado.calculaSalarioBruto(TipoEmpleado.VENDEDOR, 1250, 8));
        assertEquals(1100, empleado.calculaSalarioBruto(TipoEmpleado.VENDEDOR, 1000, 0));
        assertEquals(1060, empleado.calculaSalarioBruto(TipoEmpleado.VENDEDOR, 999.99, 3));
        assertEquals(1000, empleado.calculaSalarioBruto(TipoEmpleado.VENDEDOR, 500, 0));
        assertEquals(1160.0, empleado.calculaSalarioBruto(TipoEmpleado.VENDEDOR, 0, 8));
